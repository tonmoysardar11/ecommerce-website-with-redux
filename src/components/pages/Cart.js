  ...
  return (
    <>
      {!placed ? (
        <>
          {list.length > 0 ? (
            <div className="w-full text-gray-600 body-font lg:pt-16 md:flex md:px-5 lg:px-20">
                ...
                <div id="summary" className="w-full md:w-1/4 px-8 py-10">
                  ...
                  <span className="font-semibold text-green-500 text-xs">
                    {TotalPrice > 200
                      ...
                      : "Flat $11 discount on a Cart Value over $200 "}
                  </span>
                  <div className="py-10">
                    <label
                      htmlFor="promo"
                    ...
                    <p className="font-semibold text-green-500 text-xs">
                      {!discount
                        ? `Apply '${activepromo}' to get flat $11 discount on a Cart Value over $200 `
                        : ""}
                    </p>
                  </div>
                  <button
                  ...
                  <p
                    className={`${
                      TotalPrice > 200 && promo !== activepromo
